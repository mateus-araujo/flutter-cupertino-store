import 'package:cupertino_store/models/product/products_repository.dart';
...
class AppStateModel extends foundation.ChangeNotifier {
  ...
  List<Product> _avalableProducts = [];
  ...
  Product getProductById(int id) {
    return _avalableProducts.firstWhere((product) => product.id == id);
  }
  ...
  List<Product> getProducts() {
    if (_selectedCategory == Category.all) {
      return List.from(_avalableProducts);
    } else {
      return _avalableProducts.where((product) {
  ...
  void loadProducts() {
    _avalableProducts = ProductsRepository.loadProducts(Category.all);
    notifyListeners();
  }
